...
const Profile = () => {
    ...
    if (validateProfile()) {
      ...
      try {
        ...
        if (response.status === 200 && response.data) {
          ...
          toast.success("Profile updated succsesfully!");
          navigate("/chat");
        }
      } catch (error) {
        console.log(error);
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup) {
      ...
      toast.error("Please setup profile to start your first chat");
    }
  };
  ...
  const handleImageChange = async (event) => {
    ...
    if (file) {
      ...
      if (response.status === 200 && response.data.image) {
        ...
        toast.success("Image updated succsesfully");
      }
    }
  };
